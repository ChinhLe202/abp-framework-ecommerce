using ABP_Ecommerce.Manufacturers;
using ABP_Ecommerce.ProductAttributes;
using ABP_Ecommerce.Inventories;
using ABP_Ecommerce.InventoryTickets;
using ABP_Ecommerce.Orders;
using ABP_Ecommerce.ProductCategories;
using ABP_Ecommerce.Products;
using ABP_Ecommerce.Promotions;
...
public class ABP_EcommerceDbContext :
    AbpDbContext<ABP_EcommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public DbSet<ProductAttribueDateTime> ProductAttribueDateTimes { get; set; }
    ...
    public ABP_EcommerceDbContext(DbContextOptions<ABP_EcommerceDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfiguration(new ProductAttributeConfigruration());
